...
extension UserPreferenceByIndex on IsarCollection<UserPreference> {
  Future<UserPreference?> getByKey(String key) {
    return getByIndex(r'key', [key]);
  }

  UserPreference? getByKeySync(String key) {
  ...
  Future<List<UserPreference?>> getAllByKey(List<String> keyValues) {
    final values = keyValues.map((e) => [e]).toList();
    return getAllByIndex(r'key', values);
  }

  List<UserPreference?> getAllByKeySync(List<String> keyValues) {
    final values = keyValues.map((e) => [e]).toList();
  ...
  Future<Id> putByKey(UserPreference object) {
    return putByIndex(r'key', object);
  }

  Id putByKeySync(UserPreference object, {bool saveLinks = true}) {
    return putByIndexSync(r'key', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByKey(List<UserPreference> objects) {
    return putAllByIndex(r'key', objects);
  }

  List<Id> putAllByKeySync(List<UserPreference> objects,
      {bool saveLinks = true}) {
...
extension UserPreferenceQueryWhere
  ...
  QueryBuilder<UserPreference, UserPreference, QAfterWhereClause> keyEqualTo(
      String key) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserPreference, UserPreference, QAfterWhereClause> keyNotEqualTo(
      String key) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension UserPreferenceQuerySortBy
  ...
  QueryBuilder<UserPreference, UserPreference, QAfterSortBy> sortByKey() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'key', Sort.asc);
    });
  }

  QueryBuilder<UserPreference, UserPreference, QAfterSortBy> sortByKeyDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserPreference, UserPreference, QAfterSortBy> sortByValue() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'value', Sort.asc);
    });
  }

  QueryBuilder<UserPreference, UserPreference, QAfterSortBy> sortByValueDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserPreferenceQuerySortThenBy
  ...
  QueryBuilder<UserPreference, UserPreference, QAfterSortBy> thenByKey() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'key', Sort.asc);
    });
  }

  QueryBuilder<UserPreference, UserPreference, QAfterSortBy> thenByKeyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'key', Sort.desc);
    });
  }
  ...
  QueryBuilder<UserPreference, UserPreference, QAfterSortBy> thenByValue() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'value', Sort.asc);
    });
  }

  QueryBuilder<UserPreference, UserPreference, QAfterSortBy> thenByValueDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'value', Sort.desc);
    });
  }
...
extension UserPreferenceQueryWhereDistinct
  ...
  QueryBuilder<UserPreference, UserPreference, QDistinct> distinctByKey(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserPreference, UserPreference, QDistinct> distinctByValue(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension UserPreferenceQueryProperty
  ...
  QueryBuilder<UserPreference, String, QQueryOperations> keyProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'key');
    });
  }

  QueryBuilder<UserPreference, DateTime, QQueryOperations> updatedAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'updatedAt');
    });
  }

  QueryBuilder<UserPreference, String, QQueryOperations> valueProperty() {
    return QueryBuilder.apply(this, (query) {
