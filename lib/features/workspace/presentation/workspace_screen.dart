...
class _BreadcrumbChip extends StatelessWidget {
 ...
 label,
 style: TextStyle(
 color: isActive ? HermesColors.cyan : Theme.of(context).colorScheme.onSurfaceVariant,
 fontSize: 13,
...
class _FileEntryTile extends StatelessWidget {
 ...
 color: isDirectory ? HermesColors.warning : Theme.of(context).colorScheme.onSurfaceVariant,
 ),
 title: Text(
 entry.name,
