...
class _SessionDetailScreenState extends ConsumerState<SessionDetailScreen> {
 ...
 side: BorderSide(
 color:
 isActive ? HermesColors.success.withValues(alpha: 0.3) : Theme.of(context).colorScheme.outlineVariant,
 ),
 ),
 child: Padding(
 ...
 Icon(Icons.archive, color: HermesColors.warning, size: 18),
 ],
 ),
 ],
 ),
...
class _ActionButton extends StatelessWidget {
 ...
 side: BorderSide(
 color: enabled ? color.withValues(alpha: 0.5) : Theme.of(context).colorScheme.outlineVariant,
 ),
